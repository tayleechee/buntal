...
<?php if( empty($step1_address) || empty($step1_householdIncome) || empty($step1_numberOfFamily) || empty($step1_numberOfFamilyMember) ): ?>
	<script>window.location = "/fillForm/step1";</script>
<?php endif; ?>

<?php if(isset($step1_numberOfFamilyMember)): ?>
	<script type="text/javascript">
		var step1_numberOfFamilyMember = <?php echo e($step1_numberOfFamilyMember); ?>;
	</script>
<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Elvin\Desktop\buntal\resources\views/fillForm/step2.blade.php ENDPATH**/ ?>