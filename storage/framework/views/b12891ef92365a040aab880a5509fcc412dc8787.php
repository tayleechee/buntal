		...
		<fieldset class="scheduler-border">
			...
			<div class="form-group row pl-2 mt-3">
				...
				<div class="col form-input-col">
					<select name="gender" id="gender" class="form-control form_gender" required>
						<?php if(isset($villager->gender) && ($villager->gender == 'm')): ?>
						<option value="male" selected>Male</option>
						<?php else: ?>
						<option value="male">Male</option>
						<?php endif; ?>

						<?php if(isset($villager->gender) && ($villager->gender == 'f')): ?>
			...
			<div class="form-group row pl-2 mt-3">
				...
				<div class="col form-input-col">
					...
					<?php echo Form::select('race', ['malay' => 'Malay', 'cina' => 'Cina', 'india' =>  'India', 'bumiputera' => 'Bumiputera', 'other' => 'Lain-lain'], isset($villager->race) ? $villager->race : null, ['class'=>'form-control form_race', 'id'=>'race', 'required']); ?>
			...
			<div class="form-group row pl-2 mt-3">
				...
				<div class="col form-input-col">
					...
					<?php echo Form::select('marital', ['bujang'=>'Bujang', 'kahwin'=>'Kahwin', 'duda'=>'Duda/Janda/Balu'], isset($villager->marital_status) ? $villager->marital_status : null, ['class'=>'form-control form_marital', 'id'=>'marital', 'required']); ?>
			...
			<div class="form-group row pl-2 mt-3">
				...
				<div class="col form-input-col">
					...
					<?php echo Form::select('education', ['non-educated'=>'Non-educated', 'primary'=>'Primary School', 'secondary'=>'Secondary School', 'form6'=>'Form 6', 'diploma'=>'Diploma', 'degree'=>'Degree', 'master'=>'Master', 'phd'=>'PhD'], isset($villager->education_level) ? $villager->education_level : null, ['class'=>'form-control form_education', 'id'=>'education', 'required']); ?>
			...
			<div class="form-group row pl-2 mt-3">
				...
				<div class="ml-3">
					<div class="custom-control custom-radio custom-control-inline">
						<?php if(isset($villager->is_active) && ($villager->is_active == '1')): ?>
					...
					<div class="custom-control custom-radio custom-control-inline">
						<?php if(isset($villager->is_active) && ($villager->is_active == '0')): ?>
			...
			<div class="form-group row pl-2 mt-3">
				...
				<div class="ml-3">
					<div class="custom-control custom-radio custom-control-inline">
						<?php if(isset($villager->is_property_owner) && ($villager->is_property_owner == '1')): ?>
					...
					<div class="custom-control custom-radio custom-control-inline">
						<?php if(isset($villager->is_property_owner) && ($villager->is_property_owner == '0')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Elvin\Desktop\buntal\resources\views/villager.blade.php ENDPATH**/ ?>